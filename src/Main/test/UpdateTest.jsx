    ...
    <div className="p-4 sm:p-6">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col h-full gap-6">
        <div className="flex flex-col lg:flex-row gap-6 flex-grow">
          <div className="w-full lg:w-3/4 flex flex-col gap-4 text-sm">
            ...
            <div className="relative w-full">
              <input
                ...
                className="peer border border-gray-300 text-gray-800 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-3 pt-4 pb-1.5"
              />
              <label className="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 bg-white px-2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-2">
                Test type
              </label>
            </div>
