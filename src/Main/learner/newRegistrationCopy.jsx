        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 gap-y-10">
          ...
          <div className="mb-4">
            ...
            >
              {newLearner.photo ? (
                <img
                  src={getPreviewURL(newLearner.photo)}
          ...
          <div className="mb-4">
            ...
            >
              {newLearner.signature ? (
                <img
                  src={getPreviewURL(newLearner.signature)}
                  alt="Uploaded Preview"
                  className="w-full h-full object-contain rounded-lg"
                />
              ) : (
          ...
          <div className="mb-4">
            ...
            >
              {newLearner.aadharCard ? (
                <img
                  src={getPreviewURL(newLearner.aadharCard)}
                  alt="Uploaded Preview"
                  className="w-full h-full object-contain rounded-lg"
                />
              ) : (
          ...
          <div className="mb-4">
            ...
            >
              {newLearner.educationCertificate ? (
                <img
                  src={getPreviewURL(newLearner.educationCertificate)}
                  alt="Uploaded Preview"
                  className="w-full h-full object-contain rounded-lg"
                />
              ) : (
          ...
          <div className="mb-4">
            ...
            >
              {newLearner.passport ? (
                <img
                  src={getPreviewURL(newLearner.passport)}
                  alt="Uploaded Preview"
                  className="w-full h-full object-contain rounded-lg"
                />
              ) : (
          ...
          <div className="mb-4">
            ...
            >
              {newLearner.notary ? (
                <img
                  src={getPreviewURL(newLearner.notary)}
                  alt="Uploaded Preview"
                  className="w-full h-full object-contain rounded-lg"
                />
              ) : (
