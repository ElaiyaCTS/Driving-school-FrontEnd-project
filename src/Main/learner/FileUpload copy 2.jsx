      ...
      >
        {file ? (
          ...
          <div className="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p className="text-xs text-gray-500">PDF, JPG, PNG, JPEG (Max ~5MB)</p>
          </div>
        )}
        <input
          id={fieldName}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="relative w-11/12 max-w-2xl p-6 bg-white rounded-lg shadow-xl">
            <button
              ...
              <path fill="#e02424" fill-rule="evenodd" d="M18.645 5.291a1 1 0 0 1 .004 1.414L13.41 11.97l5.298 5.325a1 1 0 0 1-1.418 1.41L12 13.388l-5.291 5.317a1 1 0 0 1-1.418-1.41l5.298-5.325-5.238-5.265a1 1 0 0 1 1.418-1.41L12 10.552l5.231-5.257a1 1 0 0 1 1.414-.004Z" clip-rule="evenodd"/>
            </svg>
            </button>
