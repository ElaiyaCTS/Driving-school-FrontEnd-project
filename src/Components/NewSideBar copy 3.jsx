...
function NewSidebar() {
  ...
  const {role, setUser,setRole,clearAuthState} =  useRole();
...
const [showLogoutModal, setShowLogoutModal] = useState(false);
  ...
  const isActive = (path) => location.pathname.startsWith(path) ? "bg-blue-700 text-white" : "text-white dark:hover:bg-blue-800";
